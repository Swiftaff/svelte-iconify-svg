...
## test 1b fn - basic working with no options (without CommonJs)
...
## test 2 fn - basic wrong input directory returns empty object

> Snapshot 1

    {}

## test 3 fn - basic input string, not array
...
## test 9 fn - typo in icon names should log but not fail
...
## test 11a fn - no recursive file finding by default
...
## test 11b fn - recursive file finding with option
...
## test 13a fn - option transform [default=false] - check that g transform is NOT included for fa hFLip and vFlip examples by default

> Snapshot 1

    {
      'fa:arrow-circle-down': `<svg␊
      width="100%" ␊
      xmlns="http://www.w3.org/2000/svg"␊
      xmlns:xlink="http://www.w3.org/1999/xlink"␊
      aria-hidden="true"␊
      ...
      <path d="M1043 301L512 832l531 531q19 19 19 45t-19 45l-166 166q-19 19-45 19t-45-19L45 877q-19-19-19-45t19-45L787 45q19-19 45-19t45 19l166 166q19 19 19 45t-19 45z" fill="currentColor"/>␊
      <rect x="0" y="0" width="1088" height="1664" fill="rgba(0, 0, 0, 0)" />␊
      </svg>`,
...
## test 13b fn - option transform = false - check that g transform is NOT included for fa hFLip and vFlip examples
...
## test 13c fn - option transform = true - check that g transform IS included for fa hFLip and vFlip examples
...
> Snapshot 1

    {
      ...
      preserveAspectRatio="xMidYMid meet"␊
      viewBox="0 0 1536 1536">␊
      <g transform="translate(0 1536) scale(1 -1)"><path d="M1284 767q0-27-18-45L904 360l-91-91q-18-18-45-18t-45 18l-91 91l-362 362q-18 18-18 45t18 45l91 91q18 18 45 18t45-18l189-189v502q0 26 19 45t45 19h128q26 0 45-19t19-45V714l189 189q19 19 45 19t45-19l91-91q18-18 18-45zm252 1q0 209-103 385.5T1153.5 1433T768 1536t-385.5-103T103 1153.5T0 768t103-385.5T382.5 103T768 0t385.5 103T1433 382.5T1536 768z" fill="currentColor"/></g>␊
      <rect x="0" y="0" width="1536" height="1536" fill="rgba(0, 0, 0, 0)" />␊
      </svg>`,
      'fa:arrow-circle-up': `<svg␊
      width="100%" ␊
      ...
      preserveAspectRatio="xMidYMid meet"␊
      viewBox="0 0 1088 1664">␊
      <g transform="translate(1088 0) scale(-1 1)"><path d="M1043 301L512 832l531 531q19 19 19 45t-19 45l-166 166q-19 19-45 19t-45-19L45 877q-19-19-19-45t19-45L787 45q19-19 45-19t45 19l166 166q19 19 19 45t-19 45z" fill="currentColor"/></g>␊
      <rect x="0" y="0" width="1088" height="1664" fill="rgba(0, 0, 0, 0)" />␊
      </svg>`,
    }

## test 14a fn - option getCodeFromIconList [default=null] - check that it is just like test 1
...
## test 14b fn - option getCodeFromIconList = Function(iconsList, options)=>{ code, count } - check that a valid function works on 4b multiple icons example

> Snapshot 1

    {
      matches: true,
      test14b: 'emojione:hear-no-evil-monkey, emojione:see-no-evil-monkey, emojione:speak-no-evil-monkey, ',
    }

## test 14c fn - option getCodeFromIconList = AsyncFunction(iconsList, options)=>{ code, count } - check that a valid async function works on 4b multiple icons example

> Snapshot 1

    {
      matches: true,
      test14c: 'emojione:hear-no-evil-monkey, emojione:see-no-evil-monkey, emojione:speak-no-evil-monkey, ',
    }

## test 5 cli - basic working - no options, all defaults
...
## test 6 cli - basic working - single input, single output
...
## test 7 cli - basic working - multiple input
...
## test 8 cli - basic working - single input, single output, commonJs
...
## test 9 cli - typo in icon names should log but not fail
...
## test 11a cli - no recursive file finding by default
...
## test 11b cli - recursive file finding with option
...
## test 13a cli - option transform [default=false] - check that g transform is NOT included for fa hFLip and vFlip examples by default
...
## test 13b cli short - option transform = false - check that g transform is NOT included for fa hFLip and vFlip examples
...
## test 13b cli long - option transform = false - check that g transform is NOT included for fa hFLip and vFlip examples
...
## test 13c cli short - option transform = true - check that g transform IS included for fa hFLip and vFlip examples
...
## test 13c cli shorter - option transform = true - check that g transform IS included for fa hFLip and vFlip examples
...
## test 13c cli long - option transform = true - check that g transform IS included for fa hFLip and vFlip examples
